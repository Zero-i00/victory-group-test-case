        ...
        >
            <div className={cn('container', styles['product-section__wrapper'])}>
                <header className={styles['product-section__header']}>
                    ...
                    <Typography variant={'h2'} id={headingId} className={styles['product-section__heading']}>
                ...
                <div className={styles['product-section__carousel-container']}>
                    ...
                    >
                        <Carousel.Prev className={styles['product-section__arrow']} />
                        <Carousel.Content>
                            {data.map((product, i) => (
                                <Carousel.Item
                                    key={product.id}
                        ...
                        <Carousel.Next className={styles['product-section__arrow']} />

                        <div className={styles['product-section__arrows-mobile']}>
                            <Carousel.Prev className={styles['product-section__arrow-mobile']} />
                            <Carousel.Next className={styles['product-section__arrow-mobile']} />
                        </div>
                    </Carousel>
                </div>
            </div>
